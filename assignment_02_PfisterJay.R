...
person_df2 <- read.csv("c:/Users/jaybp/Desktop/dsc520/data/tidynomicon/person.csv",stringsAsFactors=FALSE)
str(person_df2)
...
db <- dbConnect (RSQLite::SQLite(),"C:/Users/jaybp/Desktop/dsc520/data/tidynomicon/example.db")
